...
export const workoutMasterEntries = [
  {
    ...
    difficulties: {
      beginner: {
        defaultSets: [{ weight: 0, reps: 12 }, { weight: 0, reps: 12 }, { weight: 0, reps: 12 }],
        maxSets: 6,
        limits: { weight: { min: 0, max: 40 }, reps: { min: 6, max: 25 } },
        points: { base: 120, perWork: 0.08, setBonus: 8, completion: 30, challengeScale: 0.5 },
        howto: '背筋を伸ばし、かかと重心でしゃがみすぎない。可動域が足りない場合は椅子に腰掛ける高さを目安に。',
      },
      intermediate: {
        defaultSets: [{ weight: 5, reps: 15 }, { weight: 5, reps: 15 }, { weight: 5, reps: 15 }, { weight: 5, reps: 15 }],
        maxSets: 7,
      ...
      advanced: {
        defaultSets: [{ weight: 10, reps: 18 }, { weight: 10, reps: 18 }, { weight: 10, reps: 18 }, { weight: 10, reps: 18 }],
        maxSets: 8,
  ...
  },
  {
    ...
    difficulties: {
      beginner: {
        defaultSets: [{ weight: 0, reps: 10 }, { weight: 0, reps: 10 }, { weight: 0, reps: 10 }],
        maxSets: 5,
      ...
      intermediate: {
        defaultSets: [{ weight: 2, reps: 12 }, { weight: 2, reps: 12 }, { weight: 2, reps: 12 }, { weight: 2, reps: 12 }],
        maxSets: 6,
  ...
  },
  {
    ...
    difficulties: {
      beginner: {
        defaultSets: [{ weight: 0, reps: 8 }, { weight: 0, reps: 8 }, { weight: 0, reps: 8 }],
        maxSets: 5,
      ...
      intermediate: {
        defaultSets: [{ weight: 4, reps: 12 }, { weight: 4, reps: 12 }, { weight: 4, reps: 12 }, { weight: 4, reps: 12 }],
        maxSets: 6,
      ...
      advanced: {
        defaultSets: [{ weight: 8, reps: 14 }, { weight: 8, reps: 14 }, { weight: 8, reps: 14 }, { weight: 8, reps: 14 }],
        maxSets: 7,
  ...
  },
  {
    ...
    difficulties: {
      beginner: {
        defaultSets: [{ timeSeconds: 40 }, { timeSeconds: 40 }, { timeSeconds: 40 }],
        maxSets: 6,
      ...
      intermediate: {
        defaultSets: [{ timeSeconds: 60 }, { timeSeconds: 60 }, { timeSeconds: 60 }, { timeSeconds: 60 }],
        maxSets: 7,
      ...
      advanced: {
        defaultSets: [{ timeSeconds: 75 }, { timeSeconds: 75 }, { timeSeconds: 75 }, { timeSeconds: 75 }],
        maxSets: 8,
  ...
  },
  {
    ...
    difficulties: {
      beginner: {
        defaultSets: [{ timeSeconds: 30 }, { timeSeconds: 30 }, { timeSeconds: 30 }],
        maxSets: 6,
      ...
      intermediate: {
        defaultSets: [{ timeSeconds: 40 }, { timeSeconds: 40 }, { timeSeconds: 40 }, { timeSeconds: 40 }],
        maxSets: 7,
        limits: { timeSeconds: { min: 20, max: 120 } },
      ...
      advanced: {
        defaultSets: [{ timeSeconds: 50 }, { timeSeconds: 50 }, { timeSeconds: 50 }, { timeSeconds: 50 }],
        maxSets: 8,
